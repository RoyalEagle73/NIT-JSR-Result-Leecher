...
github_img = PhotoImage(file = "github.png")
linkedin_img = PhotoImage(file = "linkedin.png")
nit = PhotoImage(file = "nit.png")
...
proceed_button.place(x=152, y=330)
